  ...
  public static class GameData {
    ...
    public static final List<CardData> DEFAULT_CARDS =
        List.of(
            ...
            new CardData("Brelan 1", "blue", 2, 1),
            new CardData("Brelan 2", "blue", 2, 1),
            new CardData("Brelan 3", "blue", 2, 1),
            new CardData("Brelan 4", "blue", 2, 1),
            new CardData("Brelan 5", "blue", 2, 1),
            new CardData("Brelan 6", "blue", 2, 1),
