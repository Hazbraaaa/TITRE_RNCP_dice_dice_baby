...
export default function AccountModal({
  ...
  const inputStyle =
    'bg-white border-2 border-polar-blue/30 p-3 rounded-md focus:border-polar-blue focus:outline-none font-bold text-midnight-ice placeholder:text-snow-ashes/50 transition-colors';
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} maxWidth="max-w-4xl">
      ...
      >
        {/* --- ZONE HAUTE : MODIFICATIONS --- */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-4">
          <div className="flex flex-col gap-4">
            {/* Username input */}
            <div className="flex flex-col gap-1">
              <label className="font-heading text-xs text-midnight-ice/70 ml-1">
                PSEUDO
              </label>
              <input
                type="text"
        ...
        {/* --- SEPARATION --- */}
        <div className="h-px w-full bg-gradient-to-r from-transparent via-polar-blue/30 to-transparent my-2" />

        {/* --- ZONE BASSE : VALIDATION & DANGER --- */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 items-start">
          ...
          <div className="flex flex-col gap-3 mt-6 md:mt-0">
            {/* Validation button */}
            <Button type="submit" fullWidth className="mt-4 py-3 text-sm">
              MODIFIER MON COMPTE
            </Button>
            ...
            <Button
              ...
              onClick={(e) => {
                ...
                if (
                  window.confirm('Es-tu sûr de vouloir supprimer ton compte ?')
                ) {
